...
export const NXT_GLOBAL_MANIFEST: NxtGlobalManifestEntry[] = [
  ...
  { key: 'nxtRelayID', description: 'Motor/VFD relay GP out ID (reserved from coolant/aux)' },
  { key: 'nxtAux1ID', description: 'Aux 0 GP out ID (Scylla preferred J2)' },
  { key: 'nxtAux2ID', description: 'Aux 1 GP out ID (Scylla preferred J3)' },
  { key: 'nxtAux3ID', description: 'Aux 2 GP out ID (Scylla preferred J4)' },
  { key: 'nxtBoardFanPins', description: 'Named board pins created as fans (M950 F) instead of gpOut' },
