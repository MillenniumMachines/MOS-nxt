...
export const NXT_GLOBAL_MANIFEST: NxtGlobalManifestEntry[] = [
  ...
  { key: 'nxtCalDefZ', description: 'G6511 session: rough Z deflection proposal (mm)' },
  { key: 'nxtProbeMaxSkewDeg', description: 'Max |θ| (deg) for rectangle/bore skew before abort' },
  { key: 'nxtJobG68Deg', description: 'Session: job-scoped G68 angle (null when inactive)' },
  ...
  { key: 'nxtCoolantMistID', description: 'Coolant mist GP out ID (Scylla preferred J4)' },
  { key: 'nxtCoolantFloodID', description: 'Coolant flood GP out ID (Scylla preferred J3)' },
  { key: 'nxtRelayID', description: 'Motor/VFD relay GP out ID (Scylla preferred J5, 24V)' },
  { key: 'nxtAux1ID', description: 'Aux 0 GP out ID (Scylla preferred J0, 24V)' },
  { key: 'nxtAux2ID', description: 'Aux 1 GP out ID (Scylla preferred J1, 24V)' },
  { key: 'nxtAux3ID', description: 'Aux 2 GP out ID (Scylla preferred J2, 24V)' },
  ...
  { key: 'nxtBoardPackShortName', description: 'Runtime: board shortName during/after pack resolve' },
