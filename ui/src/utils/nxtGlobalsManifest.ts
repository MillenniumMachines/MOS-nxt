...
export const NXT_GLOBAL_MANIFEST: NxtGlobalManifestEntry[] = [
  ...
  { key: 'nxtBoardKitKey', description: 'Legacy kit key (deprecated; use shortName + nxtScyllaMotorVoltage)' },
  { key: 'nxtScyllaMotorVoltage', description: 'Scylla motor supply (24 or 48); required for auto pack load when board is scylla1_0_h723' },
