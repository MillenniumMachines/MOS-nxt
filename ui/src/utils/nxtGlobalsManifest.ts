...
export const NXT_GLOBAL_MANIFEST: NxtGlobalManifestEntry[] = [
  ...
  { key: 'nxtAux1ID', description: 'Aux 1 GP out ID' },
  { key: 'nxtAux2ID', description: 'Aux 2 GP out ID' },
  { key: 'nxtAux3ID', description: 'Aux 3 GP out ID' },
  ...
  { key: 'nxtCustomXEndstopPin', description: 'Custom X endstop pin (M574 P)' },
  { key: 'nxtCustomYEndstopPin', description: 'Custom Y endstop pin (M574 P)' },
  { key: 'nxtCustomZEndstopPin', description: 'Custom Z endstop pin (M574 P)' },
