...
export const NXT_GLOBAL_MANIFEST: NxtGlobalManifestEntry[] = [
  ...
  { key: 'nxtG68Policy', description: 'Session: job-start G68 policy (0=prompt 1=always 2=never); armed by M6520 Q' },
  { key: 'nxtJobG68Deg', description: 'Session: job-scoped G68 angle (null when inactive; set by M5011)' },
  ...
  { key: 'nxtRelayID', description: 'Motor/VFD relay GP out ID (Scylla preferred P5, 24V)' },
