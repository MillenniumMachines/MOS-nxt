 ...
 *
 * Compatibility: `plugin.json` uses `dwcVersion: "auto"` (exact DWC version at build) and `rrfVersion: "auto-major"`. Rebuild the plugin ZIP when the host DWC version changes. Dev reference: **3.6.3** — `docs/RRF_REFERENCE.md`.
