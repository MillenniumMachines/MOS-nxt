    ...
    <v-card-text :class="compact ? 'pa-2' : 'pt-2'">
      ...
      <template v-if="featureEnabled">
        ...
        <template v-if="!compact">
          ...
          <div class="subtitle-2 mb-1">{{ $t('plugins.nxt.panels.rgbLight.statusColors') }}</div>
          <p class="text-caption grey--text mb-3">{{ $t('plugins.nxt.panels.rgbLight.statusColorsHint') }}</p>
          ...
          >
            ...
            <v-col cols="6" sm="2">
              <v-text-field
                ...
                hide-details
                :disabled="controlsDisabled"
                @input="onStatusHexDraft(row.id, $event)"
            ...
            <v-col cols="2" sm="1">
              <v-text-field
                ...
                hide-details
                :disabled="controlsDisabled"
                @input="onStatusChannel(row.id, 'r', $event)"
              />
            </v-col>
            <v-col cols="2" sm="1">
              <v-text-field
                ...
                hide-details
                :disabled="controlsDisabled"
                @input="onStatusChannel(row.id, 'g', $event)"
              />
            </v-col>
            <v-col cols="2" sm="1">
              <v-text-field
                ...
                hide-details
                :disabled="controlsDisabled"
                @input="onStatusChannel(row.id, 'b', $event)"
              />
            </v-col>
          ...
          <div class="d-flex flex-wrap align-center mt-3 ga-1">
            ...
            <v-chip v-if="activeTest" small color="warning" class="ml-2" label>
