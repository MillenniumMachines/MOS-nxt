; G6503-jog.g: PROBE WORK PIECE - RECTANGLE BLOCK
;
...
if { global.nxtTutorialMode && !global.mosDD[5] }
    var nxtM291Msg1a = "This probe cycle finds the X and Y co-ordinates of the center of a rectangular block (protruding feature) on a workpiece "
    var nxtM291Msg1b = { var.nxtM291Msg1a ^ "by probing towards the block surfaces from all 4 directions." }
    M291 P{var.nxtM291Msg1b} R"nxt: Probe Rect. Block " T0 S2
    M291 P"You will be asked to enter an approximate <b>width</b> and <b>length</b> of the block, and a <b>clearance distance</b>." R"nxt: Probe Rect. Block" T0 S2
    M291 P"These define how far the probe will move away from the center point before moving downwards and probing back towards the relevant surfaces." R"nxt: Probe Rect. Block" T0 S2
    ...
    M291 P"Finally, you will be asked for a <b>probe depth</b>. This is how far the probe will move downwards before probing towards the centerpoint." R"nxt: Probe Rect. Block" T0 S2
...
M291 P{var.nxtM291Msg4} R"nxt: Probe Rect. Block" J1 T0 S6 F{global.mosCL}
if { result != 0 }
    abort { "Rectangle block probe aborted!" }
...
if { var.surfaceClearance >= var.mC }
    ...
    var nxtM291Msg5 = {"The <b>clearance</b> distance is more than half of the length or width of the block.<br/>Please enter a <b>corner clearance</b> distance less than <b>" ^ var.mC ^ "</b>."}
    M291 P{var.nxtM291Msg5} R"nxt: Probe Rect. Block" J1 T0 S6 F{var.defCC}
...
M291 P{var.nxtM291Msg6} R"nxt: Probe Rect. Block" J1 T0 S6 F{global.mosOT}
if { result != 0 }
    abort { "Rectangle block probe aborted!" }
...
M291 P{var.nxtM291Msg8} R"nxt: Probe Rect. Block" J1 T0 S6 F{global.mosOT}
if { result != 0 }
    abort { "Rectangle block probe aborted!" }
...
if { global.nxtTutorialMode }
    M291 P{"Probe will now move outside each surface and down by " ^ var.probingDepth ^ "mm, before probing towards the center."} R"nxt: Probe Rect. Block" T0 S4 K{"Continue", "Cancel"} F0
    if { input != 0 }
        abort { "Rectangle block probe aborted!" }
...
G6503.1 W{var.workOffset} H{var.blockWidth} I{var.blockLength} T{var.surfaceClearance} C{var.cornerClearance} O{var.overtravel} J{var.nxtJogJ} K{var.nxtJogK} L{var.nxtJogL} Z{var.nxtJogZ}
