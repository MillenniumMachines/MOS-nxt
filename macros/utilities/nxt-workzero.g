...
if { global.nxtTutorialMode }
    var nxtWzMsg1 = { "We will now move above X=0, Y=0 in WCS " ^ move.workplaceNumber+1 ^ " and then down to Z=" ^ global.mosCL ^ "mm.<br/>Press <b>Continue</b> to proceed!" }
...
var nxtWzMsg2 = { "Move to Z=0?<br/>Click <b>Continue</b> if you are sure the tool is " ^ global.mosCL ^ "mm above the origin, otherwise <b>Cancel</b>!" }
